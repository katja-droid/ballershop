    ...
    const fetchImage = async () => {
      try {
        const response = await fetch('https://api.dropboxapi.com/2/files/search_v2', {
          ...
          headers: { // токен
            'Authorization': `Bearer sl.B0KC234PoAIdAQ7jikU3UOwJraEoQDEZS00bdZHH0iDRFGyfSmsFa0hvM61Z2DpNAoUOck1xbk1DRcgfnIkCt_95VehAVi5vInPZssl6rcka7wW3XVcTAqFXTdePKHvpCR-sqAMsb8NdNIUBQaM76bI`,
